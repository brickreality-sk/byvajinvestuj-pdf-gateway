...
// napr. https://byvajinvestuj-pdf-worker-production.up.railway.app

const PDF_WORKER_API_KEY = process.env.PDF_WORKER_API_KEY; 
// tajné, ostáva len na serveri
...
app.get("/export/pdf", async (req, res) => {
  ...
  try {
    const r = await fetch(url, {
      headers: { "x-api-key": PDF_WORKER_API_KEY },
    });
    ...
    res.setHeader(
      "Content-Disposition",
      `inline; filename="report-${template}-${reportId}.pdf"`
    );
